...
void MainGS(point VS_DATA vertex[1], inout TriangleStream<GS_DATA> triStream)
{
	...
	topLeft = float3(origin.x - halfSize, origin.y + halfSize, 0.0f);
	topRight = float3(origin.x + halfSize, origin.y + halfSize, 0.0f);
	bottomLeft = float3(origin.x - halfSize, origin.y - halfSize, 0.0f);
	bottomRight = float3(origin.x + halfSize, origin.y - halfSize, 0.0f);
